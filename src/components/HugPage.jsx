  ...
  const sendHug = () => {
    ...
    for (let i = 0; i < 25; i++) {
      ...
      newHearts.push({
        ...
        color: ["text-emerald-400", "text-sky-400", "text-teal-400", "text-cyan-400", "text-lime-400"][
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 text-center relative overflow-hidden">
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-200/35 to-sky-200/35 rounded-full blur-2xl scale-110"></div>
        <img
      ...
      <motion.button
        onClick={sendHug}
        className="mt-12 px-10 py-4 bg-gradient-to-r from-emerald-200 to-sky-200 backdrop-blur-sm border border-emerald-300/70 rounded-full text-emerald-900 text-xl hover:from-emerald-300 hover:to-sky-300 transition-all duration-500 shadow-xl shadow-emerald-100 flex gap-4 relative overflow-hidden"
        whileHover={{
          scale: 1.02,
      ...
      >
        ...
        />
        <Heart size={24} className="text-emerald-800 relative z-10" />
